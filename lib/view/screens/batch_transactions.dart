...
class BatchTransactions extends StatefulWidget {
  BatchTransactions({Key? key}) : super(key: key);

  @override
  State<BatchTransactions> createState() => _BatchTransactionsState();
}

class _BatchTransactionsState extends State<BatchTransactions>
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.only(
                        left: 25, right: 15, top: 8.0, bottom: 8.0),
                ...
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.only(
                        left: 15, right: 20, top: 8.0, bottom: 8.0),
                    child: HomeTabCardSmall(
                      onPressed: () {},
                      title: 'Amount Due',
                      icon: Icons.money,
